    ...
    <div class="item-header-container">
      ...
      <div class="tree-item-panel">
        <div class="tree-item-panel-icon" 
             v-on:click="addtrip(); setOpen(true);" v-show="isFolder"
             v-tooltip:hover="{ title: 'New trip', position: 'top' }">
        ...
        <div class="tree-item-panel-icon"
             ...
             v-tooltip:hover="{ title: 'Remove trip', position: 'top' }">
          <i class="fas fa-trash-alt"></i>
        </div>
        <div class="tree-item-panel-icon"
             v-show="!model.root && !isFolder"
...
Vue.component('tree', {
  ...
  <ul class="tree-directory tree-directory-root">
    ...
    <confirmation-message-popup v-bind:id="'remove_directory'" v-bind:onClickYes="removeDirectory">
     Вы действительно хотите удалить эту директорию со всеми trip внутри нее?
